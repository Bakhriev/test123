...
document.addEventListener('DOMContentLoaded', function () {
    ...
    wineCheckbox.addEventListener('change', function () {
        if (!this.checked) {
            const wineSuboptions = document.querySelectorAll('[name="wine_color[]"], [name="wine_type[]"]');
    ...
    champagneCheckbox.addEventListener('change', function () {
        if (!this.checked) {
            const champagneSuboptions = document.querySelectorAll('[name="cham_type[]"]');
...
const alcoholOptions = document.querySelectorAll('input[name="cham[]"], input[name="cham_type[]"], input[name="wine[]"], input[name="wine_color[]"], input[name="wine_type[]"], input[name="spirits[]"]');
...
document.querySelector('form').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        modalContent.innerHTML = '<span id="close-modal-btn" class="close">&times;</span><p>Ваш выбор успешно отправлен!</p>';
    } catch (error) {
